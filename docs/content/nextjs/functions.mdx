...
export const generateMetadata = metadataClient.getMetadata(
  async ({ searchParams }: SearchProps) => {
...
export const generateMetadata = metadataClient.getMetadata(async (props) => {
